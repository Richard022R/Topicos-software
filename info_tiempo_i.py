...
def mostrar_pantalla_informacion_tiempo(root):
    ...
    # Etiqueta de título
    titulo_label = ttk.Label(frame, text="Ecuaciones para Tiempo de Desarrollo", font=("Helvetica", 18, "bold"))
    ...
    if valor_tipo == "Organico":
        descripcion = ("Tipo de Proyecto: Orgánico\n\n"
                       "TDES = 2.5 (ESF)^0.38\n"
                       f"TDES = 2.5 ({esf:.2f})^0.38\n"
                       f"TDES = 2.5 ({esf**0.38:.2f})\n"
                       f"TDES = {tdes:.2f}"
        ...
        descripcion = ("Tipo de Proyecto: Moderado\n\n"
                       "TDES = 2.5 (ESF)^0.35\n"
                       f"TDES = 2.5 ({esf:.2f})^0.35\n"
                       f"TDES = 2.5 ({esf**0.35:.2f})\n"
                       f"TDES = {tdes:.2f}"
        )
    elif valor_tipo == "Embebido":
        descripcion = ("Tipo de Proyecto: Embebido\n\n"
                       "TDES = 2.5 (ESF)^0.32\n"
                       f"TDES = 2.5 ({esf:.2f})^0.32\n"
                       f"TDES = 2.5 ({esf**0.32:.2f})\n"
                       f"TDES = {tdes:.2f}"
        )
...
def main():
    ...
    mostrar_pantalla_informacion_tiempo(root)
