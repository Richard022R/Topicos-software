...
def mostrar_pantalla_cocomo_ii(root):
    ...
    boton_estimacion = ttk.Button(button_frame, text="Iniciar estimación", style="TButton", command=iniciar_estimacion)
    boton_estimacion.pack(pady=10, padx=10)

    # Botón para Calculo del mantenimiento
    boton_mantenimiento = ttk.Button(button_frame, text="Calculo del mantenimiento", style="TButton", command=calculo_mantenimiento)
    boton_mantenimiento.pack(pady=10, padx=10)

    # Botón para Información
    boton_informacion = ttk.Button(button_frame, text="Información", style="TButton", command=mostrar_informacion)
